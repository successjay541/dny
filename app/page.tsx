...
export default function Home() {
  ...
  // Array of image URLs - Replaced with local images
    const wineImages = [
  ...
  return (
    <>
      ...
      <main>
        {/* Home Section - Updated with Wine Hub Content */}
        <section id="home" className="section hero-section">
          <div className="hero-content">
            ...
            <div className="hero-image-container animate-fade-in">
              <div className="wine-bottle floating">
                <div className="bottle-neck"></div>
                <div className="bottle-body"></div>
                <div className="bottle-label">PREMIUM</div>
                <div className="wine-liquid"></div>
              </div>
              <div className="wine-glass floating" style={{ animationDelay: '1s' }}>
                <div className="glass-stem"></div>
                <div className="glass-bowl">
                  <div className="glass-wine"></div>
                </div>
                <div className="glass-base"></div>
              </div>
              <div className="grape-cluster floating" style={{ animationDelay: '2s' }}>
                <div className="grape"></div>
                <div className="grape"></div>
                <div className="grape"></div>
                <div className="grape"></div>
                <div className="grape-stem"></div>
              </div>
              <div className="cork floating" style={{ animationDelay: '3s' }}>
                <div className="cork-top"></div>
                <div className="cork-body"></div>
              </div>
            </div>
          </div>
        </section>
              ...
              <div className="slider-track" style={{ transform: `translateX(-${currentSlide * 100}%)` }}>
                ...
                <div className="slide">
                  <div className="slide-image slide-image-1">
                    <img src="/image/glenfidish.jpg" alt="Hero" />
                ...
                <div className="slide">
                  <div className="slide-image slide-image-2">
                    <img src="/image/Asconi.jpg" alt="Hero" />
                    <div className="image-overlay"></div>
                  </div>
                </div>
              </div>
            ...
            <div className="about-content">
              <div className="about-image-side">
                <div className="about-wine-image">
                  <img src="/image/dnylogo.jpg" alt="Hero" />
        ...
        {/* UPDATED Contact Section - Using your office address from the image */}
              ...
              <div className="contact-address animate-slide-up">
                <div className="address-card">
                  ...
                  <div className="address-details">
                    <p>Justice Mall, 3 Nnobi Lane,</p>
                    <p>Lekki Peninsula II, Lekki Eti-Osa</p>
                    <p>Lagos State, Lagos, NG</p>
                    <p>Lekki - Epe Expy, Igbo-Efon,</p>
                    <p>Lagos I06104, Lekki, Lagos,</p>
                    <p>Nigeria</p>
                  </div>
                  ...
                  <div className="contact-links">
                    ...
                    <div className="contact-item">
                      <div className="contact-image-icon">
                        <img src="/image/instagram.png" alt="Hero" />
                      </div>
                      <div className="contact-text">@Dnywineshub</div>
                    </div>
                    <div className="contact-item">
                      <div className="contact-image-icon">
                        <img src="/image/snaptchat.png" alt="Hero" />
                      </div>
                      <div className="contact-text">@Dnywineshub</div>
                    </div>
                  </div>
              ...
              <div className="contact-policies animate-slide-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="age-warning">
                  ...
                  <div className="warning-text">
                    <strong>18+ Only | Drink Responsibly</strong>
                    <p>Enjoy our premium selection responsibly and in moderation.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <style jsx>{`
        ...
        * {
        ...
        .wine-liquid {
          ...
          width: 100px;
          height: 160px;
          background: linear-gradient(to bottom, #800020, #B3002D);
          border-radius: 40px 40px 10px 10px;
          overflow: hidden;
        }
        ...
        .wine-liquid::after {
          ...
          animation: wine-shimmer 3s ease-in-out infinite;
        }
        ...
        .glass-wine {
          ...
          right: 0;
          height: 70px;
          background: linear-gradient(to top, #800020, #B3002D);
          border-radius: 40px 40px 0 0;
        ...
        .grape:nth-child(1) { top: 10px; left: 10px; }
        .grape:nth-child(2) { top: 30px; left: 30px; }
        .grape:nth-child(3) { top: 50px; left: 15px; }
        .grape:nth-child(4) { top: 70px; left: 35px; }
